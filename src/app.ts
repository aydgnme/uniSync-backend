...
app.register(import('./routes/user.routes'), { prefix: '/api/users' });
app.register(import('./routes/homework.routes'), { prefix: '/api/homework' });
app.register(import('./routes/test.routes'), { prefix: '/api/test' });
app.register(import('./routes/schedule.routes'), { prefix: '/api/schedule' });
app.register(import('./routes/course-grade.routes'), { prefix: '/api/course-grades' });
app.register(import('./routes/gridfs.routes'), { prefix: '/api/files' });
